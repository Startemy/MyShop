  ...
  <div id="app">
        ...
        <nav>
          ...
          <ul class="header__rightpart header__quantity-pos">
            <li>
              ...
              <label class="gamburger" for="burger">
                <span></span>
                <span></span>
                <span></span>
              </label>
              <div class="menu-shell hidden">
                <div class="menu-box">
                  <h2>MENU</h2>
                  <h3>MAN</h3>
                  <ul>
            ...
            <li>
              <a href="views/registration.html">
            ...
            <ul>
              ...
              <p>Итого в корзине на сумму:$<span class="ttl_price"></span></p>
            </div>
          </ul>
        </nav>
      </section>
    ...
    <section class="footer">
        <section class="footer-top">
            <div class="footer-top__box container">
                <div>
                    <img src="./assets/image/Feature/delivery_logo.svg" alt="delivery">
                    <h3>Free Delivery</h3>
                    <p>Worldwide delivery on all. Authorit tively morph next-generation
                        innov tion with extensive models.</p>
                </div>
                <div>
                    <img src="./assets/image/Feature/sale_logo.svg" alt="sale">
                    <h3>Sales & discounts</h3>
                    <p>Worldwide delivery on all. Authorit tively morph next-generation
                        innov tion with extensive models.</p>
                </div>
                <div>
                    <img src="./assets/image/Feature/acces_logo.svg" alt="sale">
        ...
        <section class="footer-mdl">
            <div class="footer-mdl__box container">
                <div class="footer-mdl__intersec">
                    <img src="./assets/image/Round_wom.jpg" alt="round">
                    <p>“Vestibulum quis porttitor dui! Quisque viverra nunc mi,
                        <span>a pulvinarpurus condimentum“</span>
                    </p>
                </div>
                <form class="footer-mdl__subscribe" action="#" method="POST">
                    <h2>SUBSCRIBE </h2>
                    <p>FOR OUR NEWLETTER AND PROMOTION</p>
                    <div>
                        <input class="footer-mdl__subscribe-input" type="email" placeholder="Enter Your Email"
                            name="email"><input class="btn" type="submit" value="Subscribe">
                    </div>
                </form>
            </div>
        </section>
        <section class="footer-botom">
            <div class="footer-botom__box container">
