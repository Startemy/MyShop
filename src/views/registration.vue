      ...
      <div class="reg-form">
        <form class="form" action="#">
          <div>
            ...
            <div class="gender">
              <i><input name="gender" type="radio" value="male"> Male</i>
              <i><input name="gender" type="radio" value="female"> Female</i>
              <i class="other"><input name="gender" type="radio" value="female"> Other</i>
            </div>
            <h2>Login details</h2>
            ...
            <p>Please use 8 or more characters, with at least 1 number and a mixture of uppercase and
                lowercase letters</p>
            <button class="button__join" type="submit">JOIN NOW
